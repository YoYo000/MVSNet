...
class UniNetDS1(Network):
    """network for 2D image feature extraction definition. Downsampling by 1."""

    def setup(self):
        (self.feed('data')
        .conv_bn(3, 32, 1, name='conv0')
        .conv_bn(3, 32, 2, name='conv1')
        .conv_bn(3, 32, 1, name='conv2')
        .conv(3, 32, 1, relu = False, name='conv3'))

class UniNetDS2_(Network):
    """network for 2D image feature extraction definition. Downsampling by 2"""

    def setup(self):
        base_filter = 8
        (self.feed('data')
        .conv_bn(5, base_filter, 2, name='conv1_0')
        .conv_bn(3, base_filter, 1, name='conv1_1')
        .conv_bn(3, base_filter, 1, name='conv1_2')
        .conv_bn(5, base_filter * 2, 2, name='conv2_0')
        .conv_bn(3, base_filter * 2, 1, name='conv2_1')
        .conv(3, base_filter * 2, 1, relu = False, name='conv2_2'))
